                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <div class=" ml-5 w-full">
                                <form id="hapusAkunForm" action="<?= BASEURL ?>/Pengguna_controller/hapusAkun" method="POST">
                                    ...
                                    <button type="button" class="delete-akun-btn text-red-600 text-sm flex items-center gap-1 justify-center mt-3 hover:text-red-800">
                    ...
                    <div class=" lg:col-span-2 flex flex-col gap-6">
                        ...
                        <div class="flex gap-4 justify-end ">
                            <a href="<?= BASEURL ?>/Pengguna_controller/editPengguna/<?= $_SESSION['user']  ['id_admin'] ?>" class="w-full block text-center bg-sky-600 text-white py-2 rounded-lg hover:bg-sky-700 transition duration-300">
                                Edit
                            </a>
                        </div>
                    </div>
