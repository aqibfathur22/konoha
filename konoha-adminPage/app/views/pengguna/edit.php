    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="bg-white lg:col-span-1 p-4 rounded-lg shadow-md">
            <div class="flex flex-col items-center gap-3">
                ...
                <form action="<?= BASEURL ?>/Pengguna_controller/gantiPassword" method="POST" class="w-full space-y-3">
        ...
        <div class="lg:col-span-2 flex flex-col gap-6">
            <form action="<?= BASEURL ?>/Pengguna_controller/updatePengguna" method="POST">
                <input type="hidden" name="id_admin" value="<?= $data['editProfil']['id_admin'] ?>">
