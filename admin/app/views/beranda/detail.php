<main class="p-4 overflow-y-auto flex-1">
    <div class="grid grid-cols-1 mt-5">
        <div class="bg-white rounded-lg p-4 shadow-md">
            ...
            <form class="form-update-status" action="<?= BASEURL ?>/Beranda/updateStatus" method="post">
                ...
                <div class="flex gap-4 w-full mt-8">
                    <button type="submit" name="status" value="menunggu"
                        class="btn-menunggu flex-1 bg-sky-600 hover:bg-sky-700 text-white py-2 rounded-lg text-center">
                        Menunggu
                    </button>
                    <button type="submit" name="status" value="diproses"
                        class="btn-diproses flex-1 bg-sky-600 hover:bg-sky-700 text-white py-2 rounded-lg text-center">
                        Diproses
                    </button>
                    <button type="submit" name="status" value="selesai"
                        class="btn-selesai flex-1 bg-sky-600 hover:bg-sky-700 text-white py-2 rounded-lg text-center">
                        Selesai
                    </button>
                    <button type="submit" name="status" value="ditolak"
                        class="btn-ditolak flex-1 bg-sky-600 hover:bg-sky-700 text-white py-2 rounded-lg text-center">
                        Ditolak
                    </button>
                </div>
            </form>
