<main class="p-8 overflow-y-auto flex-1">
    <div class="grid grid-cols-1 gap-8">
        <div class="bg-white rounded-lg p-4 shadow-md">
            ...
            <form action="<?= BASEURL; ?>/Berita/createBerita" method="post" enctype="multipart/form-data">
            ...
            <tbody class="bg-white divide-y divide-slate-200">
                ...
                <tr>
                    ...
                    <td class="px-4 py-4 w-[5%] justify-center text-center">
                        <a
                            href="<?=BASEURL?>/Berita/detail/<?= $berita['id_berita'] ?>"
                    ...
                    <td class="px-4 pr-16 py-4 w-[5%] justify-center text-center">
                        <a
                            href="<?=BASEURL?>/Berita/deleteBerita/<?= $berita['id_berita'] ?>"
